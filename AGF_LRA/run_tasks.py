...
#############################################
parser.add_argument("--poly_type", type = str, default= None)
...
parser.add_argument("--fixI", type = bool, default = False)
...
model_config["poly_type"] = poly_type
model_config["K"] = K
model_config["reg"] = reg
model_config["num_layers"] = num_layers
model_config["transformer_dim"] = transformer_dim
model_config["embedding_dim"] = transformer_dim
model_config["task"]=task
model_config["skip_train"]=args.skip_train
model_config["alpha"]=args.alpha
model_config["beta"]=args.beta
model_config["fixI"]=args.fixI
#############################################
...
log_f_path = os.path.join(checkpoint_dir, f"{task}_{attn_type}_{poly_type}_{K}_{reg}_{num_layers}_a{alpha}_b{beta}_output.log")
