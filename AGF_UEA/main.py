...
def main(config):
    ...
    logger.info("total training time (s) of the first 1K training steps: {}\n".format(avg_epoch_time))
    logger.info("peak memory usage (MB) of the first 1K training steps: {}\n".format(torch.cuda.max_memory_allocated()>>20))
